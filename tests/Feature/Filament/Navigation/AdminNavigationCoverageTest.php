...
class AdminNavigationCoverageTest extends TestCase
{
    ...
    public function test_rendered_navigation_reflects_registry_group_and_label(): void
    {
        ...
        $expectations = [
            ...
            'Instructor Topic Coverage' => 'Academics',
            // Learning Management (Phase 3.2) — learning delivery/offers,
            // deliberately Academics rather than People or Finance.
            'Learning Goals' => 'Academics',
            'Learning Plans' => 'Academics',
            'Package Offers' => 'Academics',
            'Instructor Package Proposals' => 'Academics',
