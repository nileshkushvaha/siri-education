...
final readonly class InstructorDashboardData
{
     ...
     * @param  array{status: mixed, missing: array<int, string>, percentage: int, next_action: string, show_prompt: bool, variant: string}  $onboarding  show_prompt/variant decide the dashboard onboarding-card visibility and copy; see InstructorDashboardService::onboardingPromptVisible().
     */
