...
<main class="min-h-screen bg-slate-950 text-white lg:grid lg:grid-cols-[minmax(0,0.92fr)_minmax(30rem,1.08fr)]">
    <section class="relative hidden min-h-screen overflow-hidden border-r border-white/[0.08] lg:block" aria-labelledby="login-benefits-title">
        ...
        <div class="relative flex min-h-screen flex-col p-10 xl:p-14">
            ...
            <div class="mt-16 max-w-xl xl:mt-20">
                <p class="text-sm font-semibold uppercase tracking-[0.18em] text-indigo-300">Welcome back</p>
                <h2 id="login-benefits-title" class="mt-3 text-4xl font-bold leading-tight xl:text-5xl">Pick up your learning journey where you left it.</h2>
                <p class="mt-4 max-w-lg text-base leading-relaxed text-slate-300 xl:text-lg">Your classes, homework, learning goals, progress, and account tools are ready when you sign in.</p>
            </div>

            <div class="mt-10 max-w-xl rounded-3xl border border-white/10 bg-white/[0.055] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl" aria-label="Student workspace preview">
                <div class="flex items-center justify-between border-b border-white/[0.08] pb-4">
                    <div><p class="text-xs font-semibold uppercase tracking-wider text-indigo-300">Your workspace</p><p class="mt-1 text-sm font-semibold">Today at a glance</p></div>
            ...
            <ul class="mt-8 grid max-w-xl grid-cols-2 gap-x-5 gap-y-3 text-sm text-slate-300">
    ...
    <section class="relative flex min-h-screen items-center justify-center px-4 py-6 sm:px-8 lg:px-12" aria-labelledby="login-form-title">
        <div class="w-full max-w-lg">
            ...
            <div class="rounded-3xl border border-white/[0.09] bg-white/[0.035] p-5 shadow-2xl shadow-black/20 sm:p-8">
                <div class="mb-7">
                    <p class="text-sm font-semibold text-indigo-300">Student and instructor portal</p>
                    <h1 id="login-form-title" class="mt-1 text-3xl font-bold">Sign in to your account</h1>
                    <p class="mt-2 text-sm leading-relaxed text-slate-400">Use the email and password associated with your learning account.</p>
                </div>
