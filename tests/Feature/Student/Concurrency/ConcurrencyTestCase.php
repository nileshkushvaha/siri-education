...
/**
 * Base for the Student domain's real-MySQL concurrency tests (Phase
 * 24H) — mirrors Tests\Feature\Instructor\Concurrency\ConcurrencyTestCase's
 * shape exactly, including the exit-code-checked migrate:fresh restore.
 */
