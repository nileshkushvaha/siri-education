...
<div x-data="{ showPass: false }">
    ...
    <form wire:submit="login" class="space-y-5" novalidate>
        <x-ui.auth-input
            ...
            type="email"
            wire:model="email"
            placeholder="you@sirieducation.com"
            autocomplete="email"
            required />
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" @click="showPass = !showPass" aria-label="Toggle password visibility"
                    class="absolute inset-y-0 right-0 inline-flex min-h-11 w-11 items-center justify-center rounded-r-xl text-slate-400 hover:text-white transition focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400">
                    <svg x-show="!showPass" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <x-ui.auth-button loadingText="Signing in…" loadingTarget="login">
            Sign in
