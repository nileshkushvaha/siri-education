...
/**
 * Base for the Homework domain's real-MySQL concurrency tests (Phase
 * 24K) — mirrors Tests\Feature\Instructor\Concurrency\ConcurrencyTestCase's
 * shape, including the exit-code-checked migrate:fresh restore so a
 * transient teardown failure fails loudly instead of silently leaking
 * a partially-rebuilt database into the next test class.
 */
