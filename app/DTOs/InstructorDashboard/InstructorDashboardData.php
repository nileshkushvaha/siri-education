...
final readonly class InstructorDashboardData
{
     ...
     * @param  array{status: mixed, missing: array<int, string>, percentage: int, next_action: string, items: array<int, array{key: string, label: string, step: int, done: bool}>, first_incomplete_step: ?int, show_prompt: bool, variant: string}  $onboarding  show_prompt/variant decide the dashboard onboarding-card visibility and copy; see InstructorDashboardService::onboardingPromptVisible().
     */
