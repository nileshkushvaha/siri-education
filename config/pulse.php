    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowRequests::class => [
            ...
            // check — route-level metrics elsewhere remain fully visible.
            'ignore' => [
                '#^/'.env('PULSE_PATH', 'pulse').'$#', // Pulse dashboard...
                '#^/telescope#', // Telescope dashboard...
                '#^/up$#', // Health check...
                '#^/login$#', '#^/admin/login$#', // Login...
                '#^/forgot-password#', '#^/reset-password#', // Password reset (token in URL)...
                '#^/verify-email#', // One-time-code verification screen...
                '#^/api/webhooks/#', // Payment/meeting/payout provider webhooks...
                '#^/resend/webhook$#', // Transactional-email provider webhook...
                '#^/admin/instructor-documents/.*/download$#', // Private instructor document downloads...
                '#^/filament/(exports|imports)/#', // Signed export/import download links...
            ],
        ],
