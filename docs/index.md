...
| Meeting providers (Google Meet + Zoom, provider/recording matrix, privacy) | `meetings.md` |
...
| Client guide to the Finance sidebar, workflows, configuration, and user impact | `FINANCE_MENU_GUIDE.md` |
