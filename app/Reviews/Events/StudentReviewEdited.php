 ...
 * After-commit only. The only listeners attached are the existing
 * moderation pipeline (re-moderate a now-Submitted edit) and the
 * existing rating-contribution reconciler — no notification,
