...
use App\Booking\Repositories\BookingAcademicContextRepository;
...
use App\Booking\Services\BookingArchivalService;
...
class BookingServiceProvider extends ServiceProvider
{
    ...
    private function bindInterfaces(): void
    {
        ...
        $this->app->bind(BookingAcademicContextRepositoryInterface::class, BookingAcademicContextRepository::class);
        $this->app->bind(BookingServiceInterface::class, BookingService::class);
        $this->app->bind(BookingArchivalServiceInterface::class, BookingArchivalService::class);
        ...
        $this->app->bind(WizardBookingServiceInterface::class, WizardBookingService::class);
        ...
        $this->app->bind(BookingCheckoutCompletionServiceInterface::class, BookingCheckoutCompletionService::class);
