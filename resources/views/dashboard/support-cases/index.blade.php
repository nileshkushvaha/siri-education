...
@section('account-content')
    ...
    <div class="mb-6 flex items-start justify-between gap-4">
        <div>
            <h1 class="text-xl font-bold text-white">Support Cases</h1>
            <p class="text-slate-400 text-sm mt-1">Booking, payment, wallet, and other issues you've raised with support.</p>
        </div>
