...
/**
 * Marketplace supply. An instructor is a user holding the
 * `instructor` role (identical to the Instructor Performance predicate); lifecycle
 ...
 * the Instructor Performance report (SRS §6.5) and are not
