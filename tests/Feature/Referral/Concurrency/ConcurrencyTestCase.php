...
/**
 * Base for the Referral domain's real-MySQL concurrency tests — mirrors
 * Tests\Feature\Booking\Concurrency\ConcurrencyTestCase's shape (which
 * itself mirrors the Earnings original), including the exit-code-checked,
 * bounded-retry migrate:fresh restore documented there.
 */
