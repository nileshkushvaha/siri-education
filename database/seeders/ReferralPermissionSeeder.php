...
/**
 * Referral permissions — the deliberate minimum. Idempotent.
 *
 ...
 * has it via Gate::before()). `ViewReferralCampaigns` /
 * `ManageReferralCampaigns` gate the Filament campaign resource and
 * every ReferralCampaignService mutation. Reward review and attribution
 * correction have their own permissions below.
 *
...
class ReferralPermissionSeeder extends Seeder
{
    ...
    private const array MANAGER_PERMISSIONS = [
        ...
        // Campaign administration (ReferralCampaignPolicy +
        // ReferralCampaignService both authorize against these).
        'ViewReferralCampaigns',
        'ManageReferralCampaigns',
        // Day-to-day reward operations. View + the decisions that move
        // money FORWARD along its normal path (approve a held reward,
        // reject one, retry a failed credit).
        'ViewReferralRewards',
        'ViewReferralCodes',
