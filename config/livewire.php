...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Livewire validates the TEMPORARY upload before any component rule
        // runs, and its default cap is 12 MB. The instructor introduction
        // video is allowed 50 MB (OnboardingWizard), so without this every
        // video over 12 MB failed at the upload step with a generic error
        // that no component-level rule could explain. Type/size checks per
        // field stay where they are; this only stops the pre-check from
        // undercutting them. PHP's upload_max_filesize/post_max_size must
        // also be >= 50M on the server for large videos to arrive at all.
